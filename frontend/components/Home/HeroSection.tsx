  ...
  return (
    <div className="bg-white">
      <div className="relative isolate px-6 pt-16 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl py-18 sm:py-48 lg:py-32">
          ...
          <div className="text-center">
            <h1 className="text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
              Build habits,<br/>compete with friends,<br/>level up your life
            </h1>
            <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
              Transform habit building into an exciting game. Track your progress, earn achievements, climb leaderboards, 
