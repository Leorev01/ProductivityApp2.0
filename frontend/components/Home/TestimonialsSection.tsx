...
const featuredTestimonial = {
  ...
  author: {
    name: 'Sarah Chen',
    handle: 'sarahchen',
    imageUrl: 'https://images.unsplash.com/photo-1506863530036-1efeddceb993?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
...
const testimonials = [
  [
    [
      {
        body: 'The XP system is genius. Every habit completion feels like winning, and I actually look forward to my morning routine now.',
        author: {
      ...
      {
        body: 'Finally, a habit tracker that doesn\'t feel like homework. The social features keep me motivated when I want to give up.',
        author: {
          name: 'Emily Johnson',
          handle: 'emjohnson',
    ...
    [
      {
        body: 'I\'ve tried every productivity app out there. This is the first one that made habit building actually fun and sustainable.',
        author: {
          name: 'David Kim',
          handle: 'davidkim',
  ...
  [
    [
      {
        body: 'My productivity has skyrocketed since I started using this. The friend challenges add just the right amount of healthy competition.',
        author: {
          name: 'Alex Thompson',
          handle: 'alexthompson',
    ...
    [
      {
        body: 'The analytics dashboard shows exactly where I\'m improving. Data-driven habit building is so much more effective than guessing.',
        author: {
          name: 'James Wilson',
          handle: 'jameswilson',
      ...
      {
        body: 'The reminder system is perfect - not annoying, but just persistent enough to keep me on track with my goals.',
        author: {
          name: 'Maria Garcia',
          handle: 'mariagarcia',
    ...
    <div className="relative isolate bg-gray-900 pb-32 pt-24 sm:pt-32">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm/6 text-gray-900 sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
          <figure className="rounded-2xl bg-white shadow-lg ring-1 ring-white/10 sm:col-span-2 xl:col-start-2 xl:row-end-1">
